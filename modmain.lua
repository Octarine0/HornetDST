...
Recipe("hneedle2", {Ingredient("hneedle1", 1, "images/inventoryimages/hneedle1.xml"), Ingredient("marble", 10), Ingredient("silk", 10)}, RECIPETABS.WAR, TECH.SCIENCE_TWO, nil, nil, nil, nil, "ishornet", "images/inventoryimages/hneedle2.xml", "hneedle2.tex")
